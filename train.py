...
def train(
    ...
    best_metric = -1
    best_metric_epoch = -1
    best_metric_sensitivity = -1
    best_metric_specificity = -1
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            if auc_metric > best_metric:
                ...
                best_metric_sensitivity = sensitivity
                best_metric_specificity = specificity
    ...
    logging.info(
        "train completed, best_metric: {:.4f} at epoch: {}, best_sensitivity: {:.4f}, best_specificity: {:.4f}".format(
            best_metric, best_metric_epoch, best_metric_sensitivity, best_metric_specificity
        )
    )
